...
namespace CramickHomework.Infrastructure.API.Swagger
{
	public class CustomSwaggerSchemaNameGenerator : DefaultSchemaNameGenerator
	{
		public override string Generate(Type type)
		{
			...
			return declaringTypes.Count > 0 ? $"{String.Join("", declaringTypes.Select(t => t.Name))}{type.Name}" : base.Generate(type);
		}
